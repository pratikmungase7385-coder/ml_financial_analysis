...
#📊 Stock & Finance Analyzer (FastAPI)
Overview
...
FastAPI requests financial data from a live stock API.

The received JSON data is cleaned and processed using Pandas.

Financial records are stored in a MySQL database.
...
Stores company financial data in MySQL for historical analysis.

Calculates revenue growth, profit growth, ROE, and debt ratio.

Provides structured financial summaries via REST APIs.
